      ...
      <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#m-t-modal">
...
<div class="modal fade" id="m-t-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
  <div class="modal-dialog">
    <form id="team_add_form" onsubmit="add_member(event)">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="file" name="member_picture" id="member_picture_inp" class="form-control shadow-none" required accept=".jpg, .png, .webp, .jpeg">
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" onclick="member_name_inp.value=''; member_picture_inp.value='';" class="btn text-secondary shadow-none" data-bs-dismiss="modal">
            CANCEL
          </button>
          <button type="submit" class="btn btn-dark shadow-none">SUBMIT</button>
        </div>
...
<script>
  ...
  // MODIFIED: Call all functions on load
  window.onload = function() {
    get_general();
    get_contacts();
    get_members(); // NEW: Load team members on page load
  }
</script>
